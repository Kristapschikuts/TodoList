...
//  TodoList
//
//  Created by kristaps.cikuts on 04/02/2021.
//
...
class TodoTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
   ...
   @IBOutlet weak var tableView: UITableView!
    ...
    private func addNewItem(){
        let alerController = UIAlertController(title: "Add New Task.", message: "What do you want to add?", preferredStyle: .alert)
        
        alerController.addTextField { (textField: UITextField) in
        ...
        let addAction = UIAlertAction(title: "Add", style: .cancel) { (action: UIAlertAction) in
            let textField = alerController.textFields?.first
